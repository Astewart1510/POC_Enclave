...
sgx_status_t seal_encrypted_data(const uint8_t* cipher_text, size_t cipher_text_len, uint8_t* sealed_cipher_text, size_t sealed_cipher_text_len, int64_t* sealed_length_for_trimming);
sgx_status_t unseal_aes_encrypt(const uint8_t* sealed_data_received, size_t sealed_data_received_len, uint8_t* aes_encrypted_placeholder, size_t aes_encrypted_placeholder_len, int64_t* aes_encrypted_length);
